                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="idCV" value="{{ $chucvu[0]->idCV }}" name="idCV" placeholder="Mã Chức Vụ">
                                <div class="form-group">
                                    <label class="col-md-2" for="TenPhim">Tên Chức Vụ</label>
                                    <div class="col-md-10">
                                        <div class="">
                                            <input class="form-control text-box single-line" type="text" id="TenChucVu" value="{{ $chucvu[0]->TenChucVu }}" name="TenChucVu" placeholder="Tên Chức Vụ">
                                        </div>
                                    </div>
                                </div>
