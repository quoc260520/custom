                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            ...
                            <form id="create-phim-form" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="" value="{{ $Phong[0]->idPhongChieu }}" name="idPhongChieu" placeholder="Mã Phòng">
                                <div class="form-group">
                                    <label class="col-md-2" for="">Tên Phòng </label>
                                    <div class="col-md-10">
                                        <div class="">
                                            <input class="form-control text-box single-line" type="text" id="TenPhong" value="{{ $Phong[0]->TenPhong }}" name="TenPhong" placeholder="Tên Phòng">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input class="form-control text-box single-line" type="number" id="SoHangGhe" value="{{ $Phong[0]->SoHangGhe }}" name="SoHangGhe" placeholder="Số Hàng Ghế">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="">
                                            <input class="form-control text-box single-line" type="number" id="SoGheMotHang" value="{{ $Phong[0]->SoGheMotHang }}" name="SoGheMotHang" placeholder="Số Ghế Một Hàng">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
